...
void setup() {
  ...
  Serial.println("rainfall (inches), avg wind speed (mph), gust wind speed (mph), wind direction, temperature (deg C), pressure (Pa), time since last data (ms), time of this request");
